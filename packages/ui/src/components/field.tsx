import { Label } from "@blehprint/ui/components/label";
import { Separator } from "@blehprint/ui/components/separator";
  ...
  return (
    <p
      ...
      className={cn(
        ...
        "[&>a:hover]:text-primary [&>a]:underline [&>a]:underline-offset-1",
        className,
      )}
      {...props}
    />
